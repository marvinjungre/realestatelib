...
public class MPTTest {
    ...
    public void testHistoryCleanerFlagC() {
        ...
        RealEstateAsset asset2 = new RealEstateAsset(7830, Arrays.asList(4030.03, 2540.02, 4230.01));
        RealEstateAsset asset3 = new RealEstateAsset(7950, Arrays.asList(3230.03, 140.02, 4430.01, 302.04, 230.05, 430.06, 590.07, 543.08));
    ...
    public void testHistoryCleanerFlagI() {
        ...
        RealEstateAsset asset1 = new RealEstateAsset(3680, Arrays.asList(10., 430.06, 590.07));
        RealEstateAsset asset2 = new RealEstateAsset(7830, Arrays.asList(4030.03, 2540.02));
        RealEstateAsset asset3 = new RealEstateAsset(7950, Arrays.asList(3230.03, 140.02, 4430.01, 302.04, 230.05, 430.06, 590.07, 543.08));
        ...
        int expectedLength = 8; // Based on asset3's historical returns length.
