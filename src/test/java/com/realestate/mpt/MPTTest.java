...
public class MPTTest {
    ...
    @Test
    public void testPortfolioSharpeRatioWithCleanHistoryFlagI() {
        // Define three RealEstateAssets with different historical returns
        ...
        // Define a risk-free rate for calculation. Typically obtained from a risk-free asset like a short-term government bond.
        double riskFreeRate = 0.01; // Assuming 1% annual return

        // Test the Sharpe Ratio calculation function
        double sharpeRatio = mptInstance.sharpeRatio(riskFreeRate);

        // Print out the Sharpe Ratio for manual verification
        System.out.println("Portfolio Sharpe Ratio: " + sharpeRatio);
    }
    ...
    public void testOptimizedPortfolioApprox() {
        ...
        /* RealEstateAsset asset1 = new RealEstateAsset(3680, Arrays.asList(1000.0, 1010.0, 1020.0, 1015.0, 1025.0, 1035.0, 1020.0, 1010.0, 1025.0, 1030.0, 1040.0, 1050.0));
        RealEstateAsset asset2 = new RealEstateAsset(3830, Arrays.asList(2000.0, 2200.0, 2300.0, 2100.0, 2350.0, 2500.0, 2100.0, 2200.0, 2450.0, 2300.0, 2400.0, 2500.0));
        RealEstateAsset asset3 = new RealEstateAsset(3950, Arrays.asList(1500.0, 1550.0, 1540.0, 1560.0, 1580.0, 1520.0, 1510.0, 1530.0, 1570.0, 1560.0, 1550.0, 1540.0));
        RealEstateAsset asset4 = new RealEstateAsset(2780, Arrays.asList(2100.0, 2105.0, 2108.0, 2102.0, 2107.0, 2106.0, 2104.0, 2103.0, 2109.0, 2110.0, 2101.0, 2112.0)); */
